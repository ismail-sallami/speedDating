...
?>
<title>HitchMe &hearts; View profile</title>
<meta name="keywords" content="SpeedDating, speed dating, meeting singles Berlin" />
<meta name="description" content="View singles profiles and invite them for meeting.">
</head>
<body>
<?php
                ...
                if (empty($userProfile)){
                    ...
                    <div class="col-md-4">
                        ...
                        if ($user_id != $loggedInUser->user_id) {
                            ...
                            ?>
                            <form method="POST" action= "<?= strtolower($lang['NAME']) ?>/speeddate-booking.php">
                                <input name="inviting" type="hidden" value="<?= $loggedInUser->user_id ?>">
                                <input name="guest" type="hidden" value="<?= $user_id ?>">
                                <select name="sprint" class="form-invite form-control" onchange="this.form.submit()">
                    ...
                    <div class="media-body">
                        <h1><?= $userProfile['fname']; ?>'s profile details</h1>
