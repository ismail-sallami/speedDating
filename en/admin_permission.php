...
<div class='section'>Remove Members:</div>
";
...
echo"<div class='section'>Add Members:</div>";
...
<div class='section'>Public Access:</div>";
...
echo"<div class='section'>Remove Access:</div>";
...
echo"<div class='section'>Add Access:</div>";
...
<p>
<input type='submit'  class=\"btn btn-primary btn-lg\" value='Update' class='submit' />
</p>
</form>
</body>
</html>";
